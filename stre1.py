...
from abs1 import summarize_text
...
def main():
    st.set_page_config(page_title="Text Summarization App", page_icon=":books:", layout="wide", initial_sidebar_state="expanded")
    ...
    if st.button("Summarize"):
        if text:
            try:
                ...
                st.error("Memory error: The text is too large to process. Please provide a smaller text or reduce the number of sentences requested.")
        else:
